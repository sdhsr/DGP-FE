...
class EncoderBlock(nn.Module):
    ...
    def __init__(
        ...
        self.linear= nn.Linear(in_features=dim*2, out_features=dim, bias=True)
        ...
        self.TpAttn = TemporalExternalAttn(87, 256)
    ...
    def forward(self, x, attn_bias={}):
        ...
        # new_x = x + self.drop_path(self.attn(self.norm1(x),None)+self.TpAttn(x))

        att1=self.attn(self.norm1(x),None)
        att2=self.TpAttn(x.permute(0, 2, 1))

        result = torch.cat([att1, att2.permute(0, 2, 1)], dim=2)
        new_x=self.linear(result)
...
class DecoderBlock(nn.Module):
    ...
    def __init__(
        ...
        self.dropout=0.1
        self.linear = nn.Linear(in_features=dim * 2, out_features=dim, bias=True)
        self.TpAttn = TemporalExternalAttn(174, 256)
    ...
    def forward(self, x, attn_bias={}):
        ...
        # x = x + self.drop_path(self.attn(self.norm1(x), None)+self.TpAttn(x))
